...
import navbarlogo1 from "../assets/navbarlogo1.png";
      ...
      <div className={`max-w-7xl mx-auto rounded-2xl backdrop-blur-xl border border-black transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <a href="/" className="flex items-center group">
            <img
              src={navbarlogo1}
              className="h-12 transform transition-transform duration-300 group-hover:scale-105"
              alt="Logo"
            />
          </a>
          ...
          <div className={`lg:flex ${
            ...
            <ul className="flex flex-col lg:flex-row lg:items-center lg:space-x-1 p-4 lg:p-0">
              ...
              <li>
                <a
                  href="#logout"
                  className="block px-6 py-2 ml-2 text-white rounded-lg bg-blue-600 hover:bg-blue-700 transition-all duration-300"
                >
                  Logout
                </a>
              </li>
